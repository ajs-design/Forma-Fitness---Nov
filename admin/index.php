...
if (isset($_SESSION['username'])){
	...
	require_once('plugins/promos_plugin.php');
	...
	echo "	<script>
			$(document).ready(function() { 
				...
				$('.add_item6').click(function(){
					$( '.add_items6' ).slideToggle();
				});
			}); 
			</script>";
...
<div id="tabs-6">
<h2>Promos</h2>
<button type="button" class="add_item6 s-button">Show/Hide add item</button><hr>
	<script>
	$(document).ready(function() { 
		$('.promo_remove_div').hide();
			$('.promo_remove').click(function(){
				$(this).siblings('.promo_remove_div').slideToggle();
			});
			$('.promo_remove_cnl').click(function(){
				$(this).parent('.promo_remove_div').slideToggle();
			});
	...
	<div class="add_items6">	
	<?php
		echo $promo_html;
	?>
	
	<hr><button type="button" class="add_item6 s-button">Show/Hide add item</button>
	<hr></div>
	<div class="display_items">
	<?php
	//	$promo->display_promos();
	?>
	</div>
</div>
<!-- PROMOTIONS HTML END -->	
