...
--
-- Host: localhost
-- Generation Time: Nov 17, 2013 at 07:20 PM
...
-- Database: `forma`
--
CREATE DATABASE IF NOT EXISTS `forma` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `forma`;
...
(36, 'sads', 'Sit Ups', '<p>asdasdas</p>', '', 'dsss', '2013-11-17 15:56:05', 0, 'asda');
...
(16, 'Mr', 'John', 'Cena', 'Male', 'John-Cena-john-cena-12141542-816-1023.jpg', '01295123459', 'jon@cena.com', '1979-09-18', 34, 'bobo', 'ca2cd2bcc63c4d7c8725577442073dde');
...
CREATE TABLE IF NOT EXISTS `client_measurements` (
  ...
  `c_chest` int(10) NOT NULL,
  `c_waist` int(10) NOT NULL,
  `c_hips` int(10) NOT NULL,
  `c_thighs` int(10) NOT NULL,
  `c_biceps` int(10) NOT NULL,
  PRIMARY KEY (`cm_id`),
  KEY `c_id` (`c_id`)
...
INSERT INTO `client_measurements` (`c_id`, `cm_id`, `date_taken`, `c_weight`, `c_height`, `c_chest`, `c_waist`, `c_hips`, `c_thighs`, `c_biceps`) VALUES
(15, 1, '2013-11-17 14:53:20', '79', '150', 38, 32, 26, 20, 15),
(12, 2, '2013-05-30 18:19:24', '70', '', 0, 0, 0, 0, 0),
(15, 3, '2013-05-30 18:21:41', '70', '', 0, 0, 0, 0, 0),
(15, 4, '2013-05-30 18:22:22', '13', '13', 0, 0, 0, 0, 0);
...
(11, 'feee', '<p>dfsddf</p>', '1379391_10153344049270615_833457063_n.jpg', '2013-11-17 15:48:38', 0),
(12, 'feeedsda', '<p>dfsddfsadsa</p>', '1379391_10153344049270615_833457063_n362.jpg', '2013-11-17 15:49:43', 0),
(13, 'feeedsda', '<p>dfsddfsadsa</p>', '1379391_10153344049270615_833457063_n777.jpg', '2013-11-17 15:50:26', 0),
(14, 'feeedsdadsa', '<p>dfsddfsadsadsa</p>', '1379391_10153344049270615_833457063_n1.jpg', '2013-11-17 15:50:38', 0),
(15, 'feeedsdadsa', '<p>dfsddfsadsadsa</p>', '1379391_10153344049270615_833457063_n318.jpg', '2013-11-17 15:52:27', 0),
(16, 'sdad', '<p>asdas</p>', 'hairat58-recent.jpg', '2013-11-17 15:52:47', 0),
(17, 'NOV', '<p>sdsfds</p>', 'hairat58-recent91.jpg', '2013-11-17 15:55:23', 0),
(18, 'sds', '<p>dsfds</p>', '', '2013-11-17 15:58:23', 0);
...
INSERT INTO `recipe_steps` (`r_step_id`, `r_step_desc`, `r_step_num`, `r_title`, `r_id`) VALUES
(1, 'sda', 1, 'Cheese Toastyass', 0),
(2, 'asddas', 2, 'Cheese Toastyass', 0),
(3, 'sda', 1, 'Cheese Toastyass', 0),
(4, 'asddas', 2, 'Cheese Toastyass', 0),
(5, 'dgds', 1, 'fsdgsd', 0),
(6, 'dsfsf', 1, 'dsfs', 0),
(7, 'asdad', 1, 'Chicken Dinner', 0),
(8, 'asdsd', 2, 'Chicken Dinner', 0),
(9, 'asdad', 1, 'Chicken Dinner', 0),
(10, 'asdsd', 2, 'Chicken Dinner', 0),
(11, 'asdad', 1, 'Chicken Dinner', 0),
(12, 'asdsd', 2, 'Chicken Dinner', 0),
(13, 'fdsf', 1, 'feee', 0),
(14, 'dsfsdf', 2, 'feee', 0),
(15, 'fdsfdsasda', 1, 'feeedsdadsa', 0),
(16, 'dsaas', 2, 'feeedsdadsa', 0),
(17, 'dfs', 1, 'sdad', 0),
(18, 'dsfs', 2, 'sdad', 0),
(19, 'HELLO', 1, 'NOV', 17),
(20, 'GOOD', 2, 'NOV', 17),
