...
<script src="./js/jQuery-Visualize/js/visualize.jQuery.js"></script>
<link rel="stylesheet" href="./js/jQuery-Visualize/css/visualize.css">
<link rel="stylesheet" href="./js/jQuery-Visualize/css/basic.css">
...
<div class="col_6 client_main">
	<div class="col_8 alpha omega client_nav">
		<ul>
			<li class="active stage_btn" id="stage_btn_1"><h3>Summary</h3></li>
	...
	<div class="alpha omega stage" id="stage_2">
		...
		<div class="col_2">
			<div class="notifications">
			<h3>New Program</h3>
				<p>Current program not challenging enough?</p>
				<br>
				<p>Contact your Forma Fitness trainer to make things tougher!</p> 
			</div>
		</div>
		
		<div class="col_6">
		<?php $client->display_programs($c_id);?>
			<a href="index.php?p=client&c=sessions&return=prog_chart"><button type="button">View Routine Charts</button></a>
		</div>
	</div>
	<div class="alpha omega stage" id="stage_3">
	<h2>Your Stats</h2>
		<?php $client->display_stats($c_id);?>
		<script>$('table').visualize({type: 'line'});</script>
	</div>
</div>
...
<?php 
		if(isset($_GET['return']) && ($_GET['c'] == 'sessions') && ($_GET['return'] == 'prog_chart')){
			echo "	<script>
					$(document).ready(function() {
						$('#stage_1').hide();
						$('.stage_btn').removeClass('active');
...
<div class="col_6 client_main">
	<div class="col_8 alpha omega client_nav">
		<ul>
			<li class="active stage_btn" id="stage_btn_1"><h3>Goals</h3></li>
			<li class="stage_btn" id="stage_btn_2"><h3>Routines Chart</h3></li>
		<ul>
	</div>
	<div class="alpha omega stage" id="stage_1">
		<div style="padding:0.5em;margin-right:0.5em;margin-left:0.5em;">
			<?php $client->display_program_goals($c_id);?>
		</div>
	...
	<div class="alpha omega stage" id="stage_2">
		<div style="padding:0.5em;margin-right:0.5em;margin-left:0.5em;">
			...
			<div class="routine_charts">
				<?php $client->display_routine_charts($c_id, $training);?>
			</div>
			<em>KEY</em><div style="background-color:#448ccb;width:15%;"><em>Warm-up</em></div><div style="background-color:#FF6666;width:15%;"><em>Burnout exercise</em></div>
