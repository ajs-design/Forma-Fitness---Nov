...
<div class="col_2 otm">
	<div>
		<a style="display:inline-block;width:100%;height:100%;" href="<?php $article->a_of_month_link();?>"><h3>Challenge of the month</h3></a>
	</div>
	<div>
		<a style="display:inline-block;width:100%;height:100%;" href="<?php $article->a_of_month_id();?>"><h3>Recipe of the month</h3></a>
	
	</div>
	<div>
		<h3><a href="index.php?p=articles&filter=month&year=2013&filter_desc=June&filter_result=Rowing&filter_result_id=">Client of the month</a></h3>
